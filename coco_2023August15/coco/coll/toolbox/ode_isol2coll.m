...
% evaluating f (or to a struct that contains the field 'f' with a function
% handle to a function evaluating f), an initial guess T0 and X0 for the
% time discretization and corresponding sampled time history of the state
% vector x, and initial values P0 for the problem parameters p must be
% provided to start a continuation of trajectory segments.
%
...
% $Id: ode_isol2coll.m 3288 2023-07-01 16:43:41Z hdankowicz $
